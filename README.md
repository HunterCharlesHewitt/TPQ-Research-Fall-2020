...
5. We then define the ideal of the free algrebra we defined, generated by the polynomials we used to define our relations in the B sequence. 
...
7. NormalForm(R1*R2*R1-R2*R1*R2,I) is what we use for the YBE and thus we are trying to get this to be 0
